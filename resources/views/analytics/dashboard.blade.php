<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-red-100 mb-8 overflow-hidden">
                <div class="bg-gradient-to-r from-red-800 to-red-900 px-8 py-6">
                    ...
                    <p class="text-red-100 mt-2">View Analytics with Transmuted Grades</p>
                </div>
                <div class="px-8 py-6">
            ...
            @else
                <!-- Enhanced Subject Selector & Quick Stats with Student Filter -->
                ...
                @if($selectedSubject)
                    <!-- Enhanced Key Metrics Cards with Transmuted Grades -->
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                        ...
                        <div class="group bg-gradient-to-br from-purple-500 via-purple-600 to-purple-700 text-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 relative overflow-hidden">
                            ...
                            <div class="relative">
                                ...
                                <p class="text-purple-200 text-xs mt-2 opacity-75">96+ transmuted</p>
                            </div>
                        </div>
                        ...
                        <div class="group bg-gradient-to-br from-rose-500 via-rose-600 to-rose-700 text-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 relative overflow-hidden">
                            ...
                            <div class="relative">
                                ...
                                <p class="text-rose-200 text-xs mt-2 opacity-75">&lt;75 transmuted</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
                        ...
                        <div class="bg-white p-8 rounded-2xl shadow-xl border border-red-100 hover:shadow-2xl transition-all duration-300">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <span class="text-sm text-gray-500 bg-gray-100 px-3 py-2 rounded-full font-medium">Average transmuted</span>
                            </div>
                            <div class="relative h-80 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4">
                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
                        ...
                        <div class="bg-white p-8 rounded-2xl shadow-xl border border-red-100 hover:shadow-2xl transition-all duration-300">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <span class="text-sm text-gray-500 bg-gray-100 px-3 py-2 rounded-full font-medium">Daily avg transmuted</span>
                            </div>
                            <div class="relative h-80 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4">
                        ...
                        <div class="bg-white p-8 rounded-2xl shadow-xl border border-red-100 hover:shadow-2xl transition-all duration-300">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <span class="text-sm text-gray-500 bg-gray-100 px-3 py-2 rounded-full font-medium">
                                    {{ $selectedStudent ? 'Student performance' : 'Avg transmuted per assessment' }}
                                </span>
                            </div>
                            <div class="relative h-80 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4">
                    ...
                    <!-- Enhanced Assessment Performance Table -->
                                                    ...
                                                    <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold shadow-md
                                                        {{ $performance['avg_transmuted'] >= 96 ? 'bg-gradient-to-r from-purple-100 to-purple-200 text-purple-800 border border-purple-300' : 
                                                           ($performance['avg_transmuted'] >= 92 ? 'bg-gradient-to-r from-blue-100 to-blue-200 text-blue-800 border border-blue-300' : 
                                                            ($performance['avg_transmuted'] >= 84 ? 'bg-gradient-to-r from-green-100 to-green-200 text-green-800 border border-green-300' : 
                                                             ($performance['avg_transmuted'] >= 75 ? 'bg-gradient-to-r from-yellow-100 to-yellow-200 text-yellow-800 border border-yellow-300' : 
                                                              ($performance['avg_transmuted'] >= 60 ? 'bg-gradient-to-r from-orange-100 to-orange-200 text-orange-800 border border-orange-300' : 'bg-gradient-to-r from-red-100 to-red-200 text-red-800 border border-red-300')))) }}">
                ...
                @else
                    <div class="bg-gradient-to-br from-red-50 to-red-100 border-2 border-dashed border-red-300 rounded-2xl p-12 text-center shadow-lg">
                        <div class="text-red-600">
                            ...
                            <p class="text-xl">Choose a subject from the dropdown above to view detailed analytics with transmuted grades.</p>
                        </div>
                    </div>
                @endif
            @endif
    ...
    @if($selectedSubject)
        ...
        <script>
            // Enhanced Doughnut Chart: Performance Distribution with 6 Categories
            new Chart(document.getElementById('distributionChart'), {
                type: 'doughnut',
                data: {
                    labels: ['Excellent (96-100)', 'Very Good (92-95)', 'Good (84-91)', 'Fair (76-83)', 'Passed (60-75)', 'Failed (<60)'],
                    datasets: [{
                        data: [
            ...
            // Enhanced Bar Chart: Subject Averages with Transmuted Grades
            new Chart(document.getElementById('avgChart'), {
                type: 'bar',
                data: {
                    labels: {!! json_encode($subjects->pluck('name')) !!},
                    datasets: [{
                        label: '{{ $selectedStudent ? "Student Average Transmuted Grade" : "Average Transmuted Grade" }}',
            ...
            // Enhanced Line Chart: Progress with Transmuted Grades
            ...
            new Chart(document.getElementById('columnChart'), {
                ...
                data: {
                    ...
                    datasets: [{
                        label: '{{ $selectedStudent ? "Student Transmuted Grade" : "Average Transmuted Grade" }}',
                        ...
                        backgroundColor: function(context) {
                            ...
                            if (value >= 76) return 'rgba(245, 158, 11, 0.8)';  // Yellow - Fair
                        ...
                        borderColor: function(context) {
                            ...
                            if (value >= 76) return 'rgb(245, 158, 11)';
