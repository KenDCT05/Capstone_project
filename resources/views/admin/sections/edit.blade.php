            ...
            <div class="bg-white rounded-xl shadow-xl border border-red-100 overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-red-600 via-red-700 to-rose-700 px-8 py-6 relative overflow-hidden">
                    ...
                    <div class="relative flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-white/80 mt-1 font-medium">Update section information</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('admin.sections.update', $section) }}" method="POST" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="year_level" 
                                ...
                                <option value="1" {{ old('year_level', $section->year_level) == 1 ? 'selected' : '' }}>Grade 1</option>
                                <option value="2" {{ old('year_level', $section->year_level) == 2 ? 'selected' : '' }}>Grade 2</option>
                                <option value="3" {{ old('year_level', $section->year_level) == 3 ? 'selected' : '' }}>Grade 3</option>
                                <option value="4" {{ old('year_level', $section->year_level) == 4 ? 'selected' : '' }}>Grade 4</option>
                                <option value="5" {{ old('year_level', $section->year_level) == 5 ? 'selected' : '' }}>Grade 5</option>
                                <option value="6" {{ old('year_level', $section->year_level) == 6 ? 'selected' : '' }}>Grade 6</option>
                                <option value="7" {{ old('year_level', $section->year_level) == 7 ? 'selected' : '' }}>Grade 7</option>
                                <option value="8" {{ old('year_level', $section->year_level) == 8 ? 'selected' : '' }}>Grade 8</option>
                                <option value="9" {{ old('year_level', $section->year_level) == 9 ? 'selected' : '' }}>Grade 9</option>
                                <option value="10" {{ old('year_level', $section->year_level) == 10 ? 'selected' : '' }}>Grade 10</option>
                                <option value="11" {{ old('year_level', $section->year_level) == 11 ? 'selected' : '' }}>Grade 11</option>
                                <option value="12" {{ old('year_level', $section->year_level) == 12 ? 'selected' : '' }}>Grade 12</option>
                            </select>
                            @error('year_level')
                ...
                <div class="bg-gradient-to-r from-red-50 to-rose-50 px-8 py-6 border-t border-red-100">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="text-sm">
                            <p class="font-bold text-red-900 mb-2">Section Information:</p>
                            <div class="space-y-1.5 text-red-700 font-medium">
                                <p class="flex items-center">
                                    <svg class="w-4 h-4 mr-2 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    Currently assigned to Grade {{ $section->year_level }}
                                </p>
                                <p class="flex items-center">
                                    <svg class="w-4 h-4 mr-2 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
