...
<td class="p-4">
    <div class="flex items-center justify-center gap-2 flex-wrap">
        ...
        <a href="{{ route('quizzes.leaderboard', $q) }}" 
           class="inline-flex items-center gap-1 px-3 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white text-sm font-medium rounded-lg shadow hover:shadow-md transform hover:scale-105 transition-all duration-150"
        ...
        @if($q->is_published)
            <form action="{{ route('quizzes.unpublish',$q) }}" method="POST" class="inline"
                  onsubmit="return confirm('Are you sure you want to unpublish this quiz? Students who haven\'t taken it will no longer be able to take it.')">
                @csrf
                <button type="submit"
                        class="inline-flex items-center gap-1 px-3 py-2 bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white text-sm font-medium rounded-lg shadow hover:shadow-md transform hover:scale-105 transition-all duration-150"
